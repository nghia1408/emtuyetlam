<div class="about-container">
    <div class="about-header">Về Chúng Tôi</div>
    <div class="about-content">
        <p>
            Chào mừng bạn đến với cửa hàng nội thất của chúng tôi!
            Chúng tôi chuyên cung cấp các sản phẩm nội thất chất lượng cao,
            đáp ứng mọi nhu cầu trang trí và không gian sống của bạn.
            Sứ mệnh của chúng tôi là mang đến những giải pháp nội thất tinh tế,
            tiện nghi và bền vững, giúp ngôi nhà của bạn trở nên ấm cúng và phong cách hơn.
        </p>
        <p>
            Với nhiều năm kinh nghiệm cùng niềm đam mê với thiết kế không gian sống,
            chúng tôi cam kết mọi sản phẩm đều đạt tiêu chuẩn cao nhất về chất lượng và thẩm mỹ.
            Cảm ơn bạn đã tin tưởng và lựa chọn chúng tôi!
        </p>
    </div>
    <div class="about-image">
        <img src="./assets/image/auth-image.jpg" alt="About Us" />
    </div>
</div>
